...
LIST_HYPERPARAMS = (
    # dict(cutT=6e-10, cutwidth=1e-13, expnum=13),
    ...
    dict(cutT=12e-12, cutwidth=0.05e-12, expnum=13),  # Goo
    # dict(cutT=12e-12, cutwidth=0.1e-12, expnum=13),  # Goo
    #     dict(cutT=12e-12, cutwidth=0.2e-12, expnum=13),  # Goo
    #         dict(cutT=12e-12, cutwidth=0.4e-12, expnum=13),  # Goo
    #             dict(cutT=12e-12, cutwidth=0.8e-12, expnum=13),  # Goo


    # dict(cutT=12e-12, cutwidth=1.6e-12, expnum=13),  # Goo
    # dict(cutT=13e-12, cutwidth=1.6e-12, expnum=13),  # Goo
    # dict(cutT=14e-12, cutwidth=1.6e-12, expnum=13),  # Goo
    # dict(cutT=14e-12, cutwidth=1.6e-12, expnum=13),  # Goo
    # dict(cutT=16e-12, cutwidth=1.6e-12, expnum=13),  # Goo
    # dict(cutT=17e-12, cutwidth=1.6e-12, expnum=13),  # Goo
    # dict(cutT=18e-12, cutwidth=1.6e-12, expnum=13),  # Goo
    # dict(cutT=19e-12, cutwidth=1.6e-12, expnum=13),  # Goo
    # dict(cutT=20e-12, cutwidth=1.6e-12, expnum=13),  # Goo


    # dict(cutT=12e-12, cutwidth=3.2e-12, expnum=13),  # Goo
    # dict(cutT=13e-12, cutwidth=3.2e-12, expnum=13),  # Goo
    # dict(cutT=14e-12, cutwidth=3.2e-12, expnum=13),
    # dict(cutT=15e-12, cutwidth=3.2e-12, expnum=13),
    # # dict(cutT=16e-12, cutwidth=3.2e-12, expnum=13),
    # dict(cutT=17e-12, cutwidth=3.2e-12, expnum=13),
    # dict(cutT=18e-12, cutwidth=3.2e-12, expnum=13),
    # dict(cutT=19e-12, cutwidth=3.2e-12, expnum=13),
    # dict(cutT=20e-12, cutwidth=3.2e-12, expnum=13),

    # dict(cutT=12e-12, cutwidth=4.8e-12, expnum=13),
    # dict(cutT=13e-12, cutwidth=4.8e-12, expnum=13),
    # dict(cutT=14e-12, cutwidth=4.8e-12, expnum=13),
    # dict(cutT=15e-12, cutwidth=4.8e-12, expnum=13),
    # dict(cutT=16e-12, cutwidth=4.8e-12, expnum=13),
    # dict(cutT=17e-12, cutwidth=4.8e-12, expnum=13),
    # dict(cutT=18e-12, cutwidth=4.8e-12, expnum=13),
    # dict(cutT=19e-12, cutwidth=4.8e-12, expnum=13),
    # dict(cutT=20e-12, cutwidth=4.8e-12, expnum=13),


    # dict(cutT=12e-12, cutwidth=6.4e-12, expnum=13),  # Goo
    # dict(cutT=13e-12, cutwidth=6.4e-12, expnum=13),  # Goo
    # dict(cutT=14e-12, cutwidth=6.4e-12, expnum=13),  # Goo
    # dict(cutT=15e-12, cutwidth=6.4e-12, expnum=13),  # Goo
    # dict(cutT=16e-12, cutwidth=6.4e-12, expnum=13),  # Goo
    # dict(cutT=17e-12, cutwidth=6.4e-12, expnum=13),  # Goo
    # dict(cutT=18e-12, cutwidth=6.4e-12, expnum=13),  # Goo
    # dict(cutT=19e-12, cutwidth=6.4e-12, expnum=13),  # Goo
    # dict(cutT=20e-12, cutwidth=6.4e-12, expnum=13),  # Goo


    dict(cutT=12e-12, cutwidth=8e-12, expnum=13),  # Goo
    # dict(cutT=13e-12, cutwidth=8e-12, expnum=13),  # Goo
    # dict(cutT=14e-12, cutwidth=8e-12, expnum=13),  # Goo
    # dict(cutT=15e-12, cutwidth=8e-12, expnum=13),  # Goo
    # dict(cutT=16e-12, cutwidth=8e-12, expnum=13),  # Goo
    # dict(cutT=17e-12, cutwidth=8e-12, expnum=13),  # Goo
    # dict(cutT=18e-12, cutwidth=8e-12, expnum=13),  # Goo
    # dict(cutT=19e-12, cutwidth=8e-12, expnum=13),  # Goo
    # dict(cutT=20e-12, cutwidth=8e-12, expnum=13),  # Goo
    ...
    # dict(cutT=10e-12, cutwidth=12e-12, expnum=13),  # Goo
    # dict(cutT=10e-12, cutwidth=14e-12, expnum=13),  # Goo
...
class AbsoluteDistance():
    ...
    def FFT(self, x, y):  # 等間隔データをFFT
        ...
        acf_win=1/(sum(hanning_win)/N)



        # F_abs_amp = acf*F_abs_amp #FFT後の数値に掛ければOK
        y = y*hanning_win
        y = self.zero_padding(y, 2**16)
        FF = np.fft.fft(y) *acf_win
...
for idict_Params in LIST_HYPERPARAMS:
    ...
    fig=plt.scatter(df_sort.loc["Posi_pls", :].astype(int),
                df_resultParams.loc["path_diff", :], s=0.5,label = title)
