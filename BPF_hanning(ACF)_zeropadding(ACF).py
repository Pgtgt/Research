...
LIST_HYPERPARAMS = (
    ...
    dict(cutT=2e-12, cutwidth=0.2e-12, expnum=13, PAD_EXP=4),  # Goo3
    dict(cutT=2e-12, cutwidth=0.3e-12, expnum=13, PAD_EXP=4),  # Goo3
    dict(cutT=2e-12, cutwidth=0.4e-12, expnum=13, PAD_EXP=4),  # Goo3
    dict(cutT=2e-12, cutwidth=0.5e-12, expnum=13, PAD_EXP=4),  # Goo3
